/* The following code was generated by JFlex 1.4.3 on 27.01.12 19:12 */
 ...
 * on 27.01.12 19:12 from the specification file
 * <tt>D:/user/eclipse-workspaces/eclipse-revo/SS12-CI/src/beispiel8/Scanner8.flex</tt>
 */
class Yylex {
  ...
  private static final String ZZ_CMAP_PACKED = 
    "\12\0\1\0\2\0\1\0\36\0\1\5\3\0\12\1\7\0\32\2"+
    "\4\0\1\3\1\0\32\2\2\0\1\4\uff82\0";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\2\1\3\1\4\2\2\1\5\7\0\1\3\5\0"+
    "\2\4\1\6\6\0\1\4\1\0";
   ...
   */
  Yylex(java.io.Reader in, SymTab aSymTab) {
  	symTab = aSymTab;
    this.zzReader = in;
  }
   ...
   */
  Yylex(java.io.InputStream in, SymTab aSymTab) {
    this(new java.io.InputStreamReader(in), aSymTab);
  }
  ...
  public Yytoken yylex() throws java.io.IOException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 2: 
          { int symId = symTab.insert(ICONST, yytext());
