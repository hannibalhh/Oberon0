...
object OberonParser extends App {
  ...
  //Selector         = {’.’ ident | ’[’ Expression ’]’}. // tested
  ...
  def Factor: Tree.Expression = {
    ...
    if (id.isDefined) {
      ...
      error("Factor with ident or integer or string or Read or ’(’")
      Nil
    }
  }
  ...
  //FieldList = [IdentList ’:’ Type]. // tested
  ...
  //FormalParameters = FPSection {’;’ FPSection}. // tested
  ...
  //ProcedureHeading = ’PROCEDURE’ ident ’(’ [FormalParameters] ’)’. // tested
  ...
  //ProcedureBody    = Declarations ’BEGIN’ StatementSequence ’END’ // tested
  ...
  //Assignment        = ident Selector ’:=’ Expression. // tested
  ...
  //ActualParameters  = Expression {’,’ Expression}. // tested
  ...
  //ProcedureCall = ident ’(’ [ActualParameters] ’)’. // tested
  ...
  //  	[’ELSE’ StatementSequence] ’END’. // tested
  ...
  //WhileStatement = ’WHILE’ Expression ’DO’ StatementSequence ’END’. // tested
  ...
  //RepeatStatement = ’REPEAT’ StatementSequence ’UNTIL’ Expression. // tested
  ...
  //StatementSequence = Statement {’;’ Statement}. // tested
